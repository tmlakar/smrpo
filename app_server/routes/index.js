...
router.get('/time-log/save-work-hours/stop-task/:projectId/:storyId/:taskId', ctrlMyTasks.stopTask);
router.get('/time-log/save-work-hours/start-task/:projectId/:storyId/:taskId', ctrlMyTasks.startActiveTask);
